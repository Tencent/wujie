<template>
  <div class="home">
    <div class="fixed">
      <a href="https://wujie-micro.github.io/doc/" target="_blank" class="docs">文档</a>
      <a href="https://github.com/Tencent/wujie" target="_blank" class="docs">仓库</a>
      <a-tooltip placement="top">
        <template slot="title">主应用为hash模式</template>
        <a href="https://wujie-micro.github.io/demo-main-react/" target="_blank" class="docs">react主应用</a>
      </a-tooltip>
      <a-tooltip placement="top">
        <template slot="title">预加载+预执行</template>
        <a-switch class="switch" checked-children="预加载开" un-checked-children="预加载关" v-model="preload" />
      </a-tooltip>
      <a-tooltip placement="top">
