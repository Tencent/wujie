  ...
  return (
    <nav>
      ...
      <div
        className="sub-menu"
        style={{
          display: react16Flag ? 'block' : 'none'
        }}
      >
      ...
      <div
        className="sub-menu"
        style={{
          display: react17Flag ? 'block' : 'none'
        }}
      >
