import { awaitConsoleLogMessage, getUrlSearchObject, triggerClickByJsSelector, getClassListByJsSelector } from './utils'
...
describe('main react sync', () => {
  ...
  it(`test url share`, async () => {
    ...
    expect(await getClassListByJsSelector(page, reactMainAppInfoMap.react16.dialogNavSelectorInAll)).toContain('active')
    expect(await getClassListByJsSelector(page, reactMainAppInfoMap.react17.dialogNavSelectorInAll)).toContain('active')
